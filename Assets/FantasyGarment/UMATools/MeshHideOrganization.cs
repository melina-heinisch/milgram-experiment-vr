...
public class MeshHideOrganization : MonoBehaviour
{
    ...
    public void FindMissingFiles()
    {
        ...
        string targetFilePath = "C:\\Daten\\Entwicklung\\UMA2 Test\\Assets\\UMAClothing";
        ...
        foreach (FileInfo fileInList in fileList)
        {
            ...
            if (!usedRecipes.Contains(fileInListName))
            {
                Debug.Log(String.Format("Missing recipe: {0}", fileInList.Name.Replace(".asset", "")));
            }
        }
